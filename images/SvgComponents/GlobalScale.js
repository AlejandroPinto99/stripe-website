...
const GlobalScale = () => (
    <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M22.212 44.8056C21.631 44.8272 21.1542 44.3503 21.1757 43.7693L21.4045 37.5912C21.4368 36.7186 22.4935 36.3037 23.1109 36.9211L29.0602 42.8704C29.6776 43.4878 29.2627 44.5445 28.3901 44.5768L22.212 44.8056Z" fill="#1BB978"/>
        <path d="M22 33V23C22 22.4477 22.4477 22 23 22H33" stroke="#6ED69A" strokeWidth="2" strokeLinecap="square"/>
        <path d="M44 33V43C44 43.5523 43.5523 44 43 44H33" stroke="#6ED69A" strokeWidth="2" strokeLinecap="square"/>
    </svg>
)
