    ...
    return(
        <div className="ml-2">
            <div className="border-b pb-2">
                <div className={`flex items-center space-x-2 text-base cursor-pointer pl-1 py-1 pr-14 border   ${ selected === 1 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(1)}>
                ...
                <div className={`flex items-center space-x-2 text-base cursor-pointer pl-1 py-1 pr-14 border   ${ selected === 2 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(2)}>
                ...
                <div className={`flex items-center space-x-2 text-base cursor-pointer pl-1 py-1 pr-14 border   ${ selected === 3 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(3)}>
                ...
                <div className={`flex items-center space-x-2 text-base cursor-pointer pl-1 py-1 pr-14 border   ${ selected === 4 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(4)}>
            ...
            <div className="flex items-center pt-2 cursor-pointer">
                <p className="source-sans-pro-900 text-base text-stripe-purple">Full API reference</p>
