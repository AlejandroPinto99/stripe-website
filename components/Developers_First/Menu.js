    ...
    return(
        <div className="-ml-40">
            <div className="border-b pb-4">
                <div className={`flex items-center space-x-2 text-xl cursor-pointer pl-2 py-1 pr-14 border
                  transition duartion-200 ease-in-out ${ selected === 1 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(1)}>
                ...
                <div className={`flex items-center space-x-2 text-xl cursor-pointer pl-2 py-1 pr-14 border  
                transition duartion-200 ease-in-out ${ selected === 2 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(2)}>
                ...
                <div className={`flex items-center space-x-2 text-xl cursor-pointer pl-2 py-1 pr-14 border  
                transition duartion-200 ease-in-out ${ selected === 3 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(3)}>
                ...
                <div className={`flex items-center space-x-2 text-xl cursor-pointer pl-2 py-1 pr-14 border  
                transition duartion-200 ease-in-out ${ selected === 4 ? 'bg-white shadow-sm ' : 'border-0'}`} onClick={() => handleSelect(4)}>
            ...
            <div className="flex items-center pt-4 cursor-pointer pl-2 hover:scale-105 transition duration-150 ease-in-out">
