    ...
    return(
        <div className="flex justify-between">
            <div className="flex flex-col space-y-2 w-1/3">
                <div className="flex items-center space-x-2 text-xs source-sans-pro-900 text-stripe-purple">
                    <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6 11L11 0L0 5.5L5 6L6 11Z" fill="#6772E5"/>
                    </svg>
                    <p>United States</p>
                </div>
                ...
                <div className="flex items-center space-x-2 text-xs source-sans-pro-900 text-stripe-purple">
                    <svg width="11" height="12" viewBox="0 0 11 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.40845 8.72168C9.50537 8.08691 11 6.43628 11 4.5C11 2.01465 8.5376 0 5.5 0C2.4624 0 0 2.01465 0 4.5C0 6.55981 1.69153 8.29639 4 8.83057V9V11.5C4 11.5 6.71143 10.1443 7.40845 8.72168Z" fill="#6772E5"/>
                    </svg>
                    <p>English</p>
                </div>
                ...
                <div className="flex items-end space-x-2 h-full">
                    <svg width="13" height="17" viewBox="0 0 13 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 15C9.53757 15 12 12.5376 12 9.5C12 6.46243 9.53757 4 6.5 4C3.46243 4 1 6.46243 1 9.5C1 12.5376 3.46243 15 6.5 15Z" stroke="#CFD7DF" stroke-width="0.6" stroke-linecap="square"/>
                    </svg>
